...
public abstract class BiomeGenBase
{
    ...
    public static final BiomeGenBase tutorial = (new BiomeGenTutorial(21)).setColor(0x00ff00).setBiomeName("LightStone");
    public static final BiomeGenBase tutorial2 = (new BiomeGenDarkstone(22)).setColor(0x00ff00).setBiomeName("DarkStone");
