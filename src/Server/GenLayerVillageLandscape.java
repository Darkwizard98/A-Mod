...
public class GenLayerVillageLandscape extends GenLayer
{
    ...
    public GenLayerVillageLandscape(long l, GenLayer genlayer)
    {
        ...
        allowedBiomes = (new BiomeGenBase[] {
            BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.extremeHills, BiomeGenBase.swampland, BiomeGenBase.plains, BiomeGenBase.taiga, BiomeGenBase.tutorial, BiomeGenBase.tutorial2
        });
        parent = genlayer;
    }
